...
$absen_result = $conn->query("SELECT a.id, u.name AS full_name, a.topik, a.instruktur, a.absen_date, a.foto FROM absensiprivat a JOIN userprivat u ON a.user_id = u.id ORDER BY a.absen_date DESC");
